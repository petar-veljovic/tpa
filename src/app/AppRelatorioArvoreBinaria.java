...
//------Início do trecho citado na questão 9 do relatório-------------------------------
        ...
        Aluno busca = arv.pesquisar(new Aluno(2000000101,""));   // %%%%%%%%%%%%%%%  D e s c o m e n t e
        if (busca == null)
...
//------Início do trecho citado na questão 10 do relatório-------------------------------
        ...
        // %%%%%%%%%%%%%%%%%%%%%%%% [S T A R T]  D E B U G  Z O N E
//        arv = new ArvoreBinaria(compPorMatricula);
//        gerador.geraArvorePerfeitamenteBalanceada(1,10,arv);
//        System.out.println("Quantidade de Nós: " + arv.quantidadeNos()+ " Altura: " + arv.altura()); /////
//        System.out.println("Caminho em ordem: ");
//        System.out.println(arv.caminharEmOrdem());
//        System.out.println("Caminho em nivel: ");
...
//        //Imprimo a quantidade de nós e a altura da árvore resultante
//        System.out.println("Quantidade de Nós: " + arv.quantidadeNos()+ " Altura: " + arv.altura());
//        busca = arv.pesquisar(new Aluno(2000000101,""));
//        if (busca == null)
//            System.out.println("Aluno não encontrado");
//        else
//            System.out.println("Aluno encontrado: "+busca);
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%% [E N D]  D E B U G  Z O N E
